...
(assert (and (>= (+ 1 (* (- 0 1) b__10)) 0) (= (+ (* b__10 a__2) (* (- 0 1) a__2)) 0) (>= (+ (* b__10 a__8 a__6) (* (- 0 1) (* b__10 a__6))) 0) (>= (+ (* b__10 a__5) (* b__10 a__9 a__6) (* (- 0 1) (* b__10 a__4))) 0) (>= (+ (* a__4 a__2) (* (- 0 1) (* a__5 a__2)) (* (- 0 1) (* a__7 a__3)) (- 0 1)) 0) (>= (+ a__3 (* (- 0 1) (* a__6 a__2)) (* (- 0 1) (* a__8 a__3))) 0) (>= b__10 0) (>= 1 b__10) (>= a__2 0) (>= a__8 0) (>= a__6 0) (>= a__5 0) (>= a__9 0) (>= a__4 0) (>= a__7 0) (>= a__3 0)))
(assert (<= a__2 10))
(assert (<= a__3 10))
(assert (<= a__4 10))
(assert (<= a__5 10))
