...
(assert (and (>= (+ (* a__6 a__5 a__4 a__2) (* (- 0 1) (* a__6 a__4 a__4 a__2)) (* (- 0 1) (* a__8 a__7 a__4 a__4 a__2)) (- 0 1)) 0) (>= (+ (* a__7 a__5 a__4 a__2) (* (- 0 1) (* a__5 a__4 a__2)) (* (- 0 1) (* a__5 a__2))) 0) (>= a__6 0) (>= a__5 0) (>= a__4 0) (>= a__2 0) (>= a__8 0) (>= a__7 0)))
(assert (<= a__2 10))
(assert (<= a__4 10))
(assert (<= a__5 10))
(assert (<= a__6 10))
