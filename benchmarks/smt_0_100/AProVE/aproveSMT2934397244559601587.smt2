...
(assert (and (>= (+ (* a__4 a__6 a__2) (* a__4 a__5 a__6 a__2) (* a__4 a__5 a__5 a__6 a__2) (* a__8 a__5 a__5 a__5 a__6 a__2) (- 0 1)) 0) (>= (+ (* a__6 a__6 a__2) (* (- 0 1) (* a__6 a__2))) 0) (>= a__4 0) (>= a__6 0) (>= a__2 0) (>= a__5 0) (>= a__8 0)))
(assert (<= a__2 100))
(assert (<= a__4 100))
(assert (<= a__5 100))
(assert (<= a__6 100))
